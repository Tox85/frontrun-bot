...
async function testHealthCheckLoop(count: number): Promise<void> {
...
async function testMetricsLoop(count: number): Promise<void> {
  const responseTimes: number[] = [];
...
async function testSimulationLoop(count: number): Promise<void> {
  const responseTimes: number[] = [];
...
async function testConcurrentLoad(count: number): Promise<void> {
  const startTime = Date.now();
