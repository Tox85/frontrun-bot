...
class AdvancedLoadTester {
  ...
  private async runUserLoadTest(config: LoadTestConfig, userId: number): Promise<void> {
  ...
  private calculateFinalResults(totalTime: number): void {
...
async function runAdvancedLoadTest() {
  ...
  try {
    ...
    logger.error('Erreur lors du test de charge', error as Error);
