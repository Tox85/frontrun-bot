 ...
 */
export function detectListingKRW(input: NoticeInput): ListingDetectionResult {
 ...
 */
export function detectListingKRWStrict(input: NoticeInput): ListingDetectionResult {
 ...
 */
export function detectListingKRWLoose(input: NoticeInput): ListingDetectionResult {
  const result = detectListingKRW(input);
