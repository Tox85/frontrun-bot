...
async function testDataValidation() {
    ...
    validator.registerSchema('user', {
        username: {
            ...
            maxLength: 20,
            pattern: /^[a-zA-Z0-9_]+$/,
            sanitize: DataValidator_1.DataValidator.sanitizeString
        },
        email: {
            type: 'string',
            pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
    ...
    validator.registerSchema('api_request', {
        endpoint: {
            ...
            required: true,
            pattern: /^\/[a-zA-Z0-9\/_-]+$/,
            sanitize: DataValidator_1.DataValidator.sanitizeUrl
        },
        method: {
            type: 'string',
    ...
    const sanitizedData = DataValidator_1.DataValidator.sanitizeObject(dirtyData);
...
//# sourceMappingURL=test-data-validation.js.map