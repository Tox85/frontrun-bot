...
async function testRealBithumbNotices() {
    ...
    try {
        ...
        watermarkStore = new WatermarkStore_1.WatermarkStore(db);
        ...
        noticeClient = new NoticeClient_1.NoticeClient('https://api.bithumb.com/public/notices', new HttpClient_1.HttpClient('RealBithumbTest', {
            timeoutMs: 10000,
            maxRetries: 3,
        ...
        runStats = (0, RunStats_1.getRunStatsTracker)(1); // Log toutes les minutes
        ...
        for (let i = 0; i < Math.min(realNotices.length, 10); i++) {
            ...
            if (!notice)
                continue; // Skip si notice est undefined
...
//# sourceMappingURL=test-real-bithumb.js.map