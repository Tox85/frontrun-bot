...
exports.testAntiOverlap = testAntiOverlap;
...
async function testAntiOverlap() {
    ...
    const perpCatalog = new PerpCatalog_1.PerpCatalog(db, 5000); // 5s
    try {
        ...
        try {
            ...
            console.log(`   ✅ Erreur propagée: ${error.message}`);
        ...
        try {
            ...
            console.log(`   ❌ Refresh après erreur échoué: ${error.message}`);
        }
...
//# sourceMappingURL=test-anti-overlap.js.map