"use strict";
// Test final de robustesse - Port 3001
Object.defineProperty(exports, "__esModule", { value: true });
const BASE_URL = 'http://localhost:3001';
async function testRobustnessFinal() {
    console.log('🧪 Testing Final Robustness Implementation\n');
    ...
    try {
        ...
        console.log('\n');
        // Résumé des tests
        console.log('🎯 Final Robustness Test Summary:');
        ...
        console.log(`   ✅ WebSocket: ${healthData.ws_connected ? 'CONNECTED' : 'DISCONNECTED'}`);
        console.log(`   ✅ Trading: ${statusData.trading?.enabled ? 'ENABLED' : 'DISABLED'}`);
...
// Attendre que le bot démarre
setTimeout(testRobustnessFinal, 5000);
//# sourceMappingURL=test-robustness-final.js.map