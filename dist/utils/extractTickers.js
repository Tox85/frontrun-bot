...
exports.extractTickersFromText = extractTickersFromText;
exports.calculateExtractionConfidence = calculateExtractionConfidence;
exports.extractTickersWithConfidence = extractTickersWithConfidence;
/**
...
function extractTickersFromText(text) {
    ...
    return sortedTickers.filter((ticker) => ticker !== undefined);
}
/**
 * Calcule la confiance d'une extraction basée sur la qualité du texte
 */
function calculateExtractionConfidence(originalText, decodedText, tickers) {
    let confidence = 1.0;
 ...
 */
function extractTickersWithConfidence(originalText, decodedText) {
...
//# sourceMappingURL=extractTickers.js.map